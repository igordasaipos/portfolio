...
const CursorFollow = ({ children, className = "", }) => {
    ...
    _jsxs("div", { className: `relative h-full w-full ${className}`, onBlur: handleBlur, onFocus: handleFocus, onMouseOut: handleMouseOut, onMouseOver: handleMouseOver, role: "application", style: { minHeight: 300, cursor: "none" }, 
        // biome-ignore lint/a11y/noNoninteractiveTabindex: Interactive cursor tracking widget requires focus
        tabIndex: 0, children: [children, _jsxs(motion.div, { animate: {
                    opacity: 1,
                    scale: 1,
                    transition: { duration: 0.32, ease: "easeInOut" },
                }, className: "pointer-events-none fixed z-50", exit: { opacity: 0, scale: 0.7 }, initial: { opacity: 0, scale: 0.7 }, style: { left: 0, top: 0, x: springX, y: springY }, children: [_jsx(motion.div, { animate: cursorText
                            ? {
                                width: bubbleWidth,
                                height: 40,
                                borderRadius: 20,
                            ...
                            : {
                                ...
                                scale: 1,
                            }, className: "flex items-center justify-center font-medium text-xs shadow-lg", layout: true, style: {
                            display: "flex",
                            alignItems: "center",
                        ...
                        }, transition: { duration: 0.32, ease: "easeInOut" }, children: cursorText && (_jsx(motion.span, { animate: { opacity: 1, filter: "blur(0px)" }, exit: { opacity: 0, filter: "blur(8px)" }, initial: { opacity: 0, filter: "blur(8px)" }, style: {
                                whiteSpace: "nowrap",
                                width: "100%",
                                textAlign: "center",
                                color: "#fff",
                            }, transition: { duration: 0.28, delay: 0.1, ease: "easeInOut" }, children: cursorText })) }), (pendingText || cursorText) && (_jsx("span", { ref: measureRef, style: {
                            position: "absolute",
                            visibility: "hidden",
                            pointerEvents: "none",
                            whiteSpace: "nowrap",
                            ...
                            paddingRight: 16,
                            fontFamily: "inherit",
                        }, children: pendingText || cursorText }))] })] }));
};
